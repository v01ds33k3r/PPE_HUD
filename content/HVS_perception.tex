...
% Visual salience describes features that distinguish a target from its surrounding objects [\cite{johnsonChapter5Our2014}].
...
In the top-down process, the gaze is directed toward objects related to current needs or goals. Interestingly, top-down attention reduces the impact of distracting stimuli while consciously focusing on a visual target [\cite{wareChapter1Visual2008}].

% As \cite{wareChapter1Visual2008} pragmatically points out, "seeing is all about attention."

When multiple stimuli compete for attention, even salient targets might be ignored if they are irrelevant to the current goal. This is referred to as inattentional blindness [\cite{jensenChangeBlindnessInattentional2011}]. \textcite{caterSelectiveQualityRendering2002} even leverage this effect to only partially render frames in high-quality around the current fixation point.
