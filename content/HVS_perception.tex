...
An object is referred to as visually salient, if it is distinguishable from its surroundings, without specifying which characteristics cause it to do so.
