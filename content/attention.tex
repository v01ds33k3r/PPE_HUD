...
Glanceability provides an interactive approach to countering information overload. That said, visual elements must also be designed, and in such a way as to draw the user's attention to the relevant information.

\subsection{Capturing Attention}

The rapid processing of information occurs in two steps: locating the information and then interpreting it. this process is facilitated by two guiding principles, which are the prioritization and abstraction of information.

% visual search mechanisms -> HVS

\textcite{shaoHowDynamicInformation2023}
"guide the visual flow and establish the pointing constraints of the user's line of sight"
...
talked about managing attention, what to do once we got it?
